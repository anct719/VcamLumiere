...
// Temporary CI-only license bypass. Normal builds keep license enforcement enabled;
// Makefile.ci opts into this flag while the temporary test package is published.
#ifndef VCAM_LICENSE_BYPASS
#define VCAM_LICENSE_BYPASS 0
#endif
...
#if VCAM_LICENSE_BYPASS
__attribute__((always_inline)) static BOOL _isAuth(void) { return YES; }
#else
...
#if VCAM_LICENSE_BYPASS
#define VCAM_CHK_A() (YES)
#define VCAM_CHK_B() (YES)
#define VCAM_CHK_C() (YES)
#else
